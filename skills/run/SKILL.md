...
| **Full run with memory** | `mthds-agent pipelex run <bundle-dir>/ --with-memory` | When piping output to another method |
...
- For single-input methods, the upstream's main output auto-binds to the downstream's input.
